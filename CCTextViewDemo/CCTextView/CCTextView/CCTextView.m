...
-(void)addTextViewBeginEvent:(void (^)(CCTextView *))begin{
    
    _BeginBlock = begin;
}

-(void)addTextViewEndEvent:(void (^)(CCTextView *))End{
    
    _EndBlock = End;
}

- (void)TextViewDidUpdateHeightEvent:(void (^)(CCTextView *))event{
...
-(void)textViewBeginNoti:(NSNotification*)noti{
    ...
    if (_BeginBlock) {
        void(^begin)(CCTextView *textView) = _BeginBlock;
        begin(self);
    }
}
-(void)textViewEndNoti:(NSNotification*)noti{
    ...
    if (_EndBlock) {
        void(^end)(CCTextView *textView) = _EndBlock;
        end(self);
    }
}
...
-(void)DidChange:(NSNotification*)noti{
    ...
    if (_eventBlock && self.text.length > self.maxTextLength) {
        ...
        void (^limint)(CCTextView *textView) =_eventBlock;
